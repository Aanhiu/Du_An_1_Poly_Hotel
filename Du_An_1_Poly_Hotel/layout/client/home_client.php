                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-image-part rmb-55">
                            <div class="top-part">
                                <img src="/Du_An_1_Poly_Hotel/assets2/images/about/about1.jpg" alt="About"> <a href="du_an_1_poly_hotel/?role=client"></a>
                            ...
                            <div class="bottom-part">
                                ...
                                <img src="/Du_An_1_Poly_Hotel/assets2/images/about/about2.jpg" alt="About">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
              ...
              <?php foreach($production4 as $item) : ?>
                <div class="card swiper-slide ">
                    ...
                    <div class="card-name text col-12">
                        ...
                        <a href="/du_an_1_poly_hotel/?role=client&mod=cart&id=<?php echo $item['id']?>" class="text" style="float:right ; "></a>
                    </div>
                </div>
                <?php endforeach ?>
                </div>
